...
5. **マイページの管理機能リンク削除**
   - ダッシュボードがハンバーガーにあるから不要では？

6. **テンプレートカテゴリ設定**
   - テンプレート管理のカテゴリ設定は要らない？消すべき？

### ロジック確認・機能確認
7. **メイン画面の統計情報**
   - 「要調整」とあるが、どういうロジックで出ている？
...
10. **プロジェクト管理画面の公開設定**
    - 機能している？
    - 他ユーザーへの非表示タスクと同じくらい実現したい機能

11. **ユーザー管理画面の機能性**
    - 非表示ユーザーと無効化ユーザーの違いは？
    - アプリから直接ユーザー削除でFirebaseにアクセスできない？

12. **管理者ダッシュボードのアクセス権限**
    - 加藤・朝日といった管理者以上のアカウントにも表示したい
    - チームのタスク統計を見れるようにしたい
